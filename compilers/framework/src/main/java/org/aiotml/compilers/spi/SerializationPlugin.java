 ...
 */
package org.aiotml.compilers.spi;
...
public abstract class SerializationPlugin {
    ...
    */
    public abstract String generateSerialization(StringBuilder builder, Protocol prot, Message m, ExternalConnector eco);
    
    public String generateSerialization(StringBuilder builder, Protocol prot, Message m) {
        return generateSerialization(builder, prot, m, null);
    }
     ...
     *      a AiotML message to connected ports.
     * 
