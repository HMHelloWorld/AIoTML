 ...
 */
package org.aiotml.compilers.builder;
...
public class Section extends Element {
	...
	public Element replace(Element replace, Element with) {//with替换replace处的Element
	...
	protected void perhapsOwn(Element child) {//将child的parent设置为this
	...
	public Section addBefore(Element add, Element before) {//在before位置插入add，并将before及后面全部后移
	...
	public Section addAfter(Element add, Element after) {//在after位置插入add，并将after及后面全部后移
