...
import org.aiotml.compilers.java.JavaHelper;
...
public class JavaByteArraySerializerPlugin extends SerializationPlugin {
  ...
  //TODO
    ...
    public void generateParserBody(StringBuilder builder, String bufferName, String bufferSizeName, Set<Message> messages, String sender, ExternalConnector eco) {
        copyInterface();
        builder.append("package org.aiotml.generated.network;\n\n");
        builder.append("import org.aiotml.generated.messages.*;\n");
    ...
    private void copyInterface() {
        ...
        try {
            final File folder = new File(context.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
            folder.mkdir();
            final File f = new File(context.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/BinaryJava.java");
        ...
        try {
            final File folder = new File(context.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
            folder.mkdir();
            final File f = new File(context.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/Format.java");
            final OutputStream output = new FileOutputStream(f);
        ...
        try {
            final File folder = new File(context.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
            folder.mkdir();
            final File f = new File(context.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/JavaBinaryHelper.java");
            final OutputStream output = new FileOutputStream(f);
