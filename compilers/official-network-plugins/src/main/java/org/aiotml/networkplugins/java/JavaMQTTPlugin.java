    ...
    private class SerialProtocol {
        ...
        public void generate(boolean escape) {
            ...
            try {
                final File folder = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
                folder.mkdir();
                final File f = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/MQTTJava.java");
                final OutputStream output = new FileOutputStream(f);
        ...
        private void updateMain(Context ctx, Configuration cfg, ExternalConnector conn) {
            try {
                ...
                final String subtopic = AnnotatedElementHelper.annotationOrElse(conn.getProtocol(), "mqtt_subscribe_topic", "AiotML");
                final String pubtopic = AnnotatedElementHelper.annotationOrElse(conn.getProtocol(), "mqtt_publish_topic", "AiotML");
