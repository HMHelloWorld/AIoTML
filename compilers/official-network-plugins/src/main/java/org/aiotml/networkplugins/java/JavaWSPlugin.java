    ...
    public void generateNetworkLibrary(Configuration cfg, Context ctx, Set<Protocol> protocols) {
        ...
        for (Protocol prot : protocols) {
            ...
            try {
                ...
                folder.mkdir();
                final File f = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/" + prot.getName() + "StringProtocol.java");
                final OutputStream output = new FileOutputStream(f);
    ...
    private class SerialProtocol {
        ...
        public void generate() {
            ...
            try {
                final File folder = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
                folder.mkdir();
                final File f = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/WSJava.java");
                final OutputStream output = new FileOutputStream(f);
            ...
            try {
                ...
                if (AnnotatedElementHelper.hasAnnotation(conn.getProtocol(), "server") || AnnotatedElementHelper.hasAnnotation(conn, "server")) {
                    ...
                    if ("".equals(wsProtocolName)) {
                        ...
                        final File folder3 = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
                        folder3.mkdir();
                        final File f3 = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/JavaWSProtocol.java");
                    ...
                    try {
                        final File folder = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network");
                        folder.mkdir();
                        final File f = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/JavaWSServer.java");
                        final OutputStream output = new FileOutputStream(f);
                        IOUtils.write(template, output, Charset.forName("UTF-8"));
                        IOUtils.closeQuietly(output);

                        final File f2 = new File(ctx.getOutputDirectory() + "/src/main/java/org/aiotml/generated/network/JavaWSHandler.java");
