 ...
 */
package org.aiotml.networkplugins.c.posix;
...
import org.aiotml.xtext.aiotML.impl.AiotMLFactoryImpl;
...
public class PosixMQTTPlugin extends NetworkPlugin {
    ...
    private void addDependencies() {
        if (!AnnotatedElementHelper.isDefined(cfg, "add_c_libraries", "mosquitto")) {
            AiotMLFactory factory;
            factory = AiotMLFactoryImpl.init();
    ...
    private class MQTTPort {
        ...
        List<Integer> findPublishTopicIndices(Protocol prot, ExternalConnector eco) {
            ...
            if (AnnotatedElementHelper.hasAnnotation(eco, "mqtt_topic") || AnnotatedElementHelper.hasAnnotation(eco, "mqtt_publish_topic")) {
                ...
                // Nothing is specified, use the AiotML topic
                topics.add("AiotML");
            }
        ...
        public void generateNetworkLibrary() {
            if (!ecos.isEmpty()) {
                ...
                topicList.add("AiotML"); // The default AiotML topic should always be available in the map
                ...
                if (AnnotatedElementHelper.hasAnnotation(protocol, "mqtt_client_id")) clientId = "\""+AnnotatedElementHelper.annotationOrElse(protocol, "mqtt_client_id", "AiotML")+"\"";
                ...
                String willTopic = AnnotatedElementHelper.annotationOrElse(protocol, "mqtt_will_topic", "AiotML");
