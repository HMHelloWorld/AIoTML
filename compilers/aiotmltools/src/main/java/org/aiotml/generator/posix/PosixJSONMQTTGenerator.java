 ...
 */
package org.aiotml.generator.posix;
...
public class PosixJSONMQTTGenerator extends AiotMLTool {
    ...
    public String getName() {
        return "AiotML Posix generator for messaging JSON over MQTT";
    }
    ...
    public void generateAdapterFor(AiotMLModel model, Thing t, Port p) {
    	...
    	String template = getTemplateByID("posixmqttjson/PosixMqttJson.aiotml");
    	...
    	String genfilename = t.getName() + "PosixMqttJson.aiotml";
    ...
    public void generate_parsing_msg(Port p, Message m, StringBuilder b) {
    	String template = getTemplateByID("posixmqttjson/PosixMqttJson_parsemsg.aiotml");
    ...
    public void generate_parsing_param(Port p, Message m, Parameter param, StringBuilder builder) {
    	...
    	String template = getTemplateByID("posixmqttjson/PosixMqttJson_parseparam.aiotml");
        ...
        case "long long":
        	template = template.replace("/*PARSEPARAM_STATEMENT*/", getTemplateByID("posixmqttjson/PosixMqttJson_parseparam_integer.aiotml"));
            break;
        case "float":
        case "double":
        	template = template.replace("/*PARSEPARAM_STATEMENT*/", getTemplateByID("posixmqttjson/PosixMqttJson_parseparam_double.aiotml"));
            break;
        case "bool":
        case "boolean":
        case "char":
