 ...
 */
package org.aiotml.generator.go;
...
public class GoSONMQTTGenerator extends AiotMLTool {
    ...
    public String getName() {
        return "AiotML Go generator for messaging JSON over MQTT";
    }
    ...
    public void generateAdapterFor(AiotMLModel model, Thing t, Port p) {
    	...
    	String template = getTemplateByID("gomqttjson/GoMqttJson.aiotml");
    	...
    	String genfilename = t.getName() + "GoMqttJson.aiotml";
    ...
    public void generate_send_handler(Port p, Message m, StringBuilder b) {
    	...
    	final Thing t = AiotMLHelpers.findContainingThing(m);
