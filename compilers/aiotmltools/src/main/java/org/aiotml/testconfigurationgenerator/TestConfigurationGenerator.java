 ...
 */
package org.aiotml.testconfigurationgenerator;
 ...
 * @author sintef
 */
public class TestConfigurationGenerator extends AiotMLTool {
    ...
    public void generateCfg(Thing t, String in, String out, Language lang, int testNumber) {
        ...
        builder.append("import \"../../../src/main/resources/tests/aiotml.aiotml\"\n\n");

        builder.append("import \"../../../src/main/resources/tests/core/_" + lang.longName + "/test.aiotml\"\n");
        builder.append("import \"../../../src/main/resources/tests/" + src.getParentFile().getName() + "/" + LowerFirstLetter(t.getName()) + ".aiotml\"\n");
        //builder.append("import \"" + src.getAbsolutePath() + "\"\n");
        builder.append("import \"../../../src/main/resources/tests/core/_" + lang.longName + "/timer.aiotml\"\n");
        ...
        generatedCode.put("_" + lang.longName + "/" + t.getName() + "_" + testNumber + ".aiotml", builder);
    }
