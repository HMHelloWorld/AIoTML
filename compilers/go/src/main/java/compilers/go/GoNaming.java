...
public class GoNaming {
	...
	/* -- Naming strategy -- */
	private AiotMLSwitch<Name> namingStrategy = new AiotMLSwitch<Name>() {
	...
	/* --- Scoping strategy --- */
	private AiotMLSwitch<NameScope> nameScopingStrategy = new AiotMLSwitch<NameScope>() {
	...
	private AiotMLSwitch<NameScope> nestedScopingStrategy = new AiotMLSwitch<NameScope>() {
		...
		public NameScope caseMessage(Message object) {
			NameScope thingScope = internalGetScopeFor(AiotMLHelpers.findContainingThing(object));
