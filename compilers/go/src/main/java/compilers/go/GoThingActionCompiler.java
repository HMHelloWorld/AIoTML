...
import org.aiotml.compilers.thing.common.NewCommonThingActionCompiler;
...
public class GoThingActionCompiler extends NewCommonThingActionCompiler {
	...
	public void generate(SendAction action, Section section, Context ctx) {
		...
		final String port_name = gctx.currentThingContext.getThing().getName() + "_" + AiotMLHelpers.findContainingThing(action.getPort()).getName() + "_" + action.getPort().getName();
