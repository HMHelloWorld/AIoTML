...
import org.aiotml.testing.errors.AiotMLOutputError;
import org.aiotml.testing.tests.AiotMLFileTest;
import org.aiotml.testing.utilities.CommandRunner.Output;
import org.aiotml.xtext.aiotML.Configuration;

public class GeneralTest extends AiotMLFileTest {
	private static final long serialVersionUID = 1L;
	
	protected ArrayList<GeneralTestInputOutput> inputoutputs;

	public GeneralTest(File aiotmlFile, String className, String[] compilers) {
	...
	public void verifyExecutionResults(String compiler, Configuration configuration, File directory, Output executorResult) throws AssertionError {
		...
		if (!allCorrect) {
			throw new AiotMLOutputError(comparison.toString());
		}
	}
}
