 ...
 */
package org.aiotml.testing.utilities;

import java.io.File;
import java.util.concurrent.TimeUnit;

import org.apache.commons.io.IOUtils;
import org.aiotml.testing.errors.AiotMLExecutionError;
	...
	public static class Output {
		...
		Output(Process p, String command, long timeout) throws Exception {
			try {
				...
				throw new AiotMLTimeoutError("Timeout while executing '"+command+"'");
			}
		...
		public void checkException(String message) throws AiotMLExecutionError {
			if (exception != null) throw new AiotMLExecutionError(message+" - Exception", this, exception);
		}
		
		public void checkZeroReturn(String message) throws AiotMLExecutionError {
			if (returnValue != 0) throw new AiotMLExecutionError(message+" - Non-zero return value", this);
		}
		
		public void check(String message) throws AiotMLExecutionError {
