...
public enum Result {
	...
	public static Result fromFailure(String failure) {
		...
		if (failure.equals("skipped"))
			return SKIPPED;
		if (failure.equals("org.aiotml.testing.errors.AiotMLLoadModelError"))
			return LOADMODELERROR;
		if (failure.equals("org.aiotml.testing.errors.AiotMLCheckerError"))
			return CHECKERERROR;
		if (failure.equals("org.aiotml.testing.errors.AiotMLOutputError"))
			return OUTPUTERROR;
		if (failure.equals("org.aiotml.testing.errors.AiotMLCompilationError"))
			return COMPILATIONERROR;
		if (failure.equals("org.aiotml.testing.errors.AiotMLExecutionError"))
			return EXECUTIONERROR;
		if (failure.equals("org.aiotml.testing.errors.AiotMLTimeoutError"))
			return TIMEOUT;
