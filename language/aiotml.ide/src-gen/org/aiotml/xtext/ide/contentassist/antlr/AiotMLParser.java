...
import org.aiotml.xtext.ide.contentassist.antlr.internal.InternalAiotMLParser;
import org.aiotml.xtext.services.AiotMLGrammarAccess;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class AiotMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(AiotMLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AiotMLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAiotMLModelAccess().getAlternatives_2(), "rule__AiotMLModel__Alternatives_2");
			...
			builder.put(grammarAccess.getLayerAccess().getAlternatives_5(), "rule__Layer__Alternatives_5");
			builder.put(grammarAccess.getLayerAccess().getAfAlternatives_10_0(), "rule__Layer__AfAlternatives_10_0");
			builder.put(grammarAccess.getStrategyAccess().getAlternatives_3(), "rule__Strategy__Alternatives_3");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getAlternatives_5(), "rule__StrategyAssignment__Alternatives_5");
			builder.put(grammarAccess.getThingAccess().getAlternatives_6(), "rule__Thing__Alternatives_6");
			builder.put(grammarAccess.getSubThingAccess().getAlternatives_3(), "rule__SubThing__Alternatives_3");
			builder.put(grammarAccess.getCpropertyAccess().getAlternatives_3(), "rule__Cproperty__Alternatives_3");
			...
			builder.put(grammarAccess.getLocalVariableAccess().getAlternatives_4(), "rule__LocalVariable__Alternatives_4");
			builder.put(grammarAccess.getZipEnumerateAccess().getFnameAlternatives_4_0(), "rule__ZipEnumerate__FnameAlternatives_4_0");
			...
			builder.put(grammarAccess.getAiotMLModelAccess().getGroup(), "rule__AiotMLModel__Group__0");
			...
			builder.put(grammarAccess.getNamedElementAccess().getGroup_17(), "rule__NamedElement__Group_17__0");
			builder.put(grammarAccess.getAnnotatedElementAccess().getGroup_14(), "rule__AnnotatedElement__Group_14__0");
			...
			builder.put(grammarAccess.getTensorAccess().getGroup(), "rule__Tensor__Group__0");
			builder.put(grammarAccess.getTensorAccess().getGroup_6(), "rule__Tensor__Group_6__0");
			builder.put(grammarAccess.getTensorAccess().getGroup_8(), "rule__Tensor__Group_8__0");
			builder.put(grammarAccess.getLayerAccess().getGroup(), "rule__Layer__Group__0");
			builder.put(grammarAccess.getLayerAccess().getGroup_5_0(), "rule__Layer__Group_5_0__0");
			builder.put(grammarAccess.getLayerAccess().getGroup_5_0_1(), "rule__Layer__Group_5_0_1__0");
			builder.put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
			builder.put(grammarAccess.getModelAccess().getGroup_4(), "rule__Model__Group_4__0");
			builder.put(grammarAccess.getModelReferenceAccess().getGroup(), "rule__ModelReference__Group__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup(), "rule__Strategy__Group__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_0(), "rule__Strategy__Group_3_0__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_1(), "rule__Strategy__Group_3_1__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_2(), "rule__Strategy__Group_3_2__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_3(), "rule__Strategy__Group_3_3__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_4(), "rule__Strategy__Group_3_4__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_4_5(), "rule__Strategy__Group_3_4_5__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_4_5_1(), "rule__Strategy__Group_3_4_5_1__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_5(), "rule__Strategy__Group_3_5__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_5_5(), "rule__Strategy__Group_3_5_5__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_5_5_1(), "rule__Strategy__Group_3_5_5_1__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_6(), "rule__Strategy__Group_3_6__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_6_7(), "rule__Strategy__Group_3_6_7__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_7(), "rule__Strategy__Group_3_7__0");
			builder.put(grammarAccess.getStrategyAccess().getGroup_3_8(), "rule__Strategy__Group_3_8__0");
			builder.put(grammarAccess.getMultiAgentAccess().getGroup(), "rule__MultiAgent__Group__0");
			builder.put(grammarAccess.getMultiAgentPropertyAccess().getGroup(), "rule__MultiAgentProperty__Group__0");
			builder.put(grammarAccess.getStrategyPropertyAccess().getGroup(), "rule__StrategyProperty__Group__0");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getGroup(), "rule__StrategyAssignment__Group__0");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getGroup_5_0(), "rule__StrategyAssignment__Group_5_0__0");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getGroup_5_1(), "rule__StrategyAssignment__Group_5_1__0");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getGroup_5_2(), "rule__StrategyAssignment__Group_5_2__0");
			...
			builder.put(grammarAccess.getSubThingAccess().getGroup(), "rule__SubThing__Group__0");
			...
			builder.put(grammarAccess.getCpropertyAccess().getGroup(), "rule__Cproperty__Group__0");
			...
			builder.put(grammarAccess.getFunctionAccess().getGroup_0_6(), "rule__Function__Group_0_6__0");
			...
			builder.put(grammarAccess.getPropertyAccess().getGroup_4_0_1(), "rule__Property__Group_4_0_1__0");
			...
			builder.put(grammarAccess.getLocalVariableAccess().getGroup_4_0(), "rule__LocalVariable__Group_4_0__0");
			builder.put(grammarAccess.getLocalVariableAccess().getGroup_4_0_1(), "rule__LocalVariable__Group_4_0_1__0");
			...
			builder.put(grammarAccess.getVariableAssignmentAccess().getGroup_2(), "rule__VariableAssignment__Group_2__0");
			builder.put(grammarAccess.getVariableAssignmentAccess().getGroup_2_2(), "rule__VariableAssignment__Group_2_2__0");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getGroup(), "rule__CpropertyAssignment__Group__0");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getGroup_2(), "rule__CpropertyAssignment__Group_2__0");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getGroup_3(), "rule__CpropertyAssignment__Group_3__0");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getGroup_3_2(), "rule__CpropertyAssignment__Group_3_2__0");
			builder.put(grammarAccess.getStrategyStreamAccess().getGroup(), "rule__StrategyStream__Group__0");
			builder.put(grammarAccess.getStrategyStreamAccess().getGroup_2(), "rule__StrategyStream__Group_2__0");
			builder.put(grammarAccess.getStrategyStreamAccess().getGroup_7(), "rule__StrategyStream__Group_7__0");
			builder.put(grammarAccess.getDictAssignmentAccess().getGroup(), "rule__DictAssignment__Group__0");
			builder.put(grammarAccess.getDictAssignmentAccess().getGroup_1(), "rule__DictAssignment__Group_1__0");
			builder.put(grammarAccess.getZipEnumerateAccess().getGroup(), "rule__ZipEnumerate__Group__0");
			builder.put(grammarAccess.getZipEnumerateAccess().getGroup_2(), "rule__ZipEnumerate__Group_2__0");
			builder.put(grammarAccess.getZipEnumerateAccess().getGroup_7(), "rule__ZipEnumerate__Group_7__0");
			...
			builder.put(grammarAccess.getPyforActionAccess().getGroup(), "rule__PyforAction__Group__0");
			builder.put(grammarAccess.getPyforActionAccess().getGroup_3(), "rule__PyforAction__Group_3__0");
			builder.put(grammarAccess.getPyforActionAccess().getGroup_6(), "rule__PyforAction__Group_6__0");
			...
			builder.put(grammarAccess.getReturnActionAccess().getGroup_3(), "rule__ReturnAction__Group_3__0");
			...
			builder.put(grammarAccess.getCpropertyReferenceAccess().getGroup(), "rule__CpropertyReference__Group__0");
			builder.put(grammarAccess.getCpropertyReferenceAccess().getGroup_2(), "rule__CpropertyReference__Group_2__0");
			builder.put(grammarAccess.getCpropertyReferenceAccess().getGroup_3(), "rule__CpropertyReference__Group_3__0");
			builder.put(grammarAccess.getCpropertyReferenceAccess().getGroup_3_2(), "rule__CpropertyReference__Group_3_2__0");
			...
			builder.put(grammarAccess.getAiotMLModelAccess().getImportsAssignment_0(), "rule__AiotMLModel__ImportsAssignment_0");
			builder.put(grammarAccess.getAiotMLModelAccess().getTemplatesAssignment_1(), "rule__AiotMLModel__TemplatesAssignment_1");
			builder.put(grammarAccess.getAiotMLModelAccess().getTypesAssignment_2_0(), "rule__AiotMLModel__TypesAssignment_2_0");
			builder.put(grammarAccess.getAiotMLModelAccess().getProtocolsAssignment_2_1(), "rule__AiotMLModel__ProtocolsAssignment_2_1");
			builder.put(grammarAccess.getAiotMLModelAccess().getConfigsAssignment_2_2(), "rule__AiotMLModel__ConfigsAssignment_2_2");
			builder.put(grammarAccess.getTemplateAccess().getPathAssignment_1(), "rule__Template__PathAssignment_1");
			...
			builder.put(grammarAccess.getNamedElementAccess().getNameAssignment_17_1(), "rule__NamedElement__NameAssignment_17_1");
			builder.put(grammarAccess.getAnnotatedElementAccess().getAnnotationsAssignment_14_1(), "rule__AnnotatedElement__AnnotationsAssignment_14_1");
			...
			builder.put(grammarAccess.getVariableAccess().getTensorAssignment_1(), "rule__Variable__TensorAssignment_1");
			...
			builder.put(grammarAccess.getTensorAccess().getDimsAssignment_5(), "rule__Tensor__DimsAssignment_5");
			builder.put(grammarAccess.getTensorAccess().getDimsAssignment_6_1(), "rule__Tensor__DimsAssignment_6_1");
			builder.put(grammarAccess.getTensorAccess().getDatatypeAssignment_8_1(), "rule__Tensor__DatatypeAssignment_8_1");
			builder.put(grammarAccess.getLayerAccess().getLayernumsAssignment_5_0_0(), "rule__Layer__LayernumsAssignment_5_0_0");
			builder.put(grammarAccess.getLayerAccess().getLayernumsAssignment_5_0_1_1(), "rule__Layer__LayernumsAssignment_5_0_1_1");
			builder.put(grammarAccess.getLayerAccess().getNumAssignment_5_1(), "rule__Layer__NumAssignment_5_1");
			builder.put(grammarAccess.getLayerAccess().getAfAssignment_10(), "rule__Layer__AfAssignment_10");
			builder.put(grammarAccess.getModelAccess().getNameAssignment_1(), "rule__Model__NameAssignment_1");
			builder.put(grammarAccess.getModelAccess().getLayersAssignment_4_1(), "rule__Model__LayersAssignment_4_1");
			builder.put(grammarAccess.getModelReferenceAccess().getNameAssignment_2(), "rule__ModelReference__NameAssignment_2");
			builder.put(grammarAccess.getModelReferenceAccess().getTypeRefAssignment_4(), "rule__ModelReference__TypeRefAssignment_4");
			builder.put(grammarAccess.getStrategyAccess().getNameAssignment_1(), "rule__Strategy__NameAssignment_1");
			builder.put(grammarAccess.getStrategyAccess().getTensorAssignment_3_0_2(), "rule__Strategy__TensorAssignment_3_0_2");
			builder.put(grammarAccess.getStrategyAccess().getTensorAssignment_3_1_2(), "rule__Strategy__TensorAssignment_3_1_2");
			builder.put(grammarAccess.getStrategyAccess().getDevicesAssignment_3_2_3(), "rule__Strategy__DevicesAssignment_3_2_3");
			builder.put(grammarAccess.getStrategyAccess().getTensorAssignment_3_3_2(), "rule__Strategy__TensorAssignment_3_3_2");
			builder.put(grammarAccess.getStrategyAccess().getRewdimsAssignment_3_4_5_0(), "rule__Strategy__RewdimsAssignment_3_4_5_0");
			builder.put(grammarAccess.getStrategyAccess().getRewdimsAssignment_3_4_5_1_1(), "rule__Strategy__RewdimsAssignment_3_4_5_1_1");
			builder.put(grammarAccess.getStrategyAccess().getObsdimsAssignment_3_5_5_0(), "rule__Strategy__ObsdimsAssignment_3_5_5_0");
			builder.put(grammarAccess.getStrategyAccess().getObsdimsAssignment_3_5_5_1_1(), "rule__Strategy__ObsdimsAssignment_3_5_5_1_1");
			builder.put(grammarAccess.getStrategyAccess().getActiondimsAssignment_3_6_6(), "rule__Strategy__ActiondimsAssignment_3_6_6");
			builder.put(grammarAccess.getStrategyAccess().getActiondimsAssignment_3_6_7_1(), "rule__Strategy__ActiondimsAssignment_3_6_7_1");
			builder.put(grammarAccess.getStrategyAccess().getPmodelAssignment_3_7_2(), "rule__Strategy__PmodelAssignment_3_7_2");
			builder.put(grammarAccess.getStrategyAccess().getQmodelAssignment_3_8_2(), "rule__Strategy__QmodelAssignment_3_8_2");
			builder.put(grammarAccess.getStrategyAccess().getAnnotationsAssignment_5(), "rule__Strategy__AnnotationsAssignment_5");
			builder.put(grammarAccess.getMultiAgentAccess().getNameAssignment_1(), "rule__MultiAgent__NameAssignment_1");
			builder.put(grammarAccess.getMultiAgentAccess().getAgentsAssignment_3(), "rule__MultiAgent__AgentsAssignment_3");
			builder.put(grammarAccess.getMultiAgentAccess().getAnnotationsAssignment_5(), "rule__MultiAgent__AnnotationsAssignment_5");
			builder.put(grammarAccess.getMultiAgentPropertyAccess().getNameAssignment_2(), "rule__MultiAgentProperty__NameAssignment_2");
			builder.put(grammarAccess.getMultiAgentPropertyAccess().getTypeRefAssignment_4(), "rule__MultiAgentProperty__TypeRefAssignment_4");
			builder.put(grammarAccess.getStrategyPropertyAccess().getNameAssignment_2(), "rule__StrategyProperty__NameAssignment_2");
			builder.put(grammarAccess.getStrategyPropertyAccess().getTypeRefAssignment_4(), "rule__StrategyProperty__TypeRefAssignment_4");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getStrategyAssignment_1(), "rule__StrategyAssignment__StrategyAssignment_1");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getAgentAssignment_3(), "rule__StrategyAssignment__AgentAssignment_3");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getRbindFunctionAssignment_5_0_2(), "rule__StrategyAssignment__RbindFunctionAssignment_5_0_2");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getIbindFunctionAssignment_5_1_2(), "rule__StrategyAssignment__IbindFunctionAssignment_5_1_2");
			builder.put(grammarAccess.getStrategyAssignmentAccess().getObindFunctionAssignment_5_2_2(), "rule__StrategyAssignment__ObindFunctionAssignment_5_2_2");
			...
			builder.put(grammarAccess.getThingAccess().getCpropertiesAssignment_6_3(), "rule__Thing__CpropertiesAssignment_6_3");
			builder.put(grammarAccess.getThingAccess().getFunctionsAssignment_6_4(), "rule__Thing__FunctionsAssignment_6_4");
			builder.put(grammarAccess.getThingAccess().getAssignAssignment_6_5(), "rule__Thing__AssignAssignment_6_5");
			builder.put(grammarAccess.getThingAccess().getStrategysAssignment_6_6(), "rule__Thing__StrategysAssignment_6_6");
			builder.put(grammarAccess.getThingAccess().getSassignsAssignment_6_7(), "rule__Thing__SassignsAssignment_6_7");
			builder.put(grammarAccess.getThingAccess().getMasAssignment_6_8(), "rule__Thing__MasAssignment_6_8");
			builder.put(grammarAccess.getThingAccess().getBehaviourAssignment_7(), "rule__Thing__BehaviourAssignment_7");
			builder.put(grammarAccess.getSubThingAccess().getNameAssignment_1(), "rule__SubThing__NameAssignment_1");
			builder.put(grammarAccess.getSubThingAccess().getPropertiesAssignment_3_0(), "rule__SubThing__PropertiesAssignment_3_0");
			builder.put(grammarAccess.getSubThingAccess().getFunctionsAssignment_3_1(), "rule__SubThing__FunctionsAssignment_3_1");
			builder.put(grammarAccess.getAgentAccess().getNameAssignment_1(), "rule__Agent__NameAssignment_1");
			builder.put(grammarAccess.getAgentAccess().getCardinalityAssignment_2_1(), "rule__Agent__CardinalityAssignment_2_1");
			builder.put(grammarAccess.getAgentAccess().getAmodelAssignment_3(), "rule__Agent__AmodelAssignment_3");
			builder.put(grammarAccess.getCpropertyAccess().getNameAssignment_1(), "rule__Cproperty__NameAssignment_1");
			builder.put(grammarAccess.getCpropertyAccess().getTypeRefAssignment_3_0(), "rule__Cproperty__TypeRefAssignment_3_0");
			builder.put(grammarAccess.getCpropertyAccess().getTensorAssignment_3_1(), "rule__Cproperty__TensorAssignment_3_1");
			builder.put(grammarAccess.getCpropertyAccess().getAnnotationsAssignment_4(), "rule__Cproperty__AnnotationsAssignment_4");
			...
			builder.put(grammarAccess.getFunctionAccess().getExtraTypeRefAssignment_0_6_1(), "rule__Function__ExtraTypeRefAssignment_0_6_1");
			builder.put(grammarAccess.getFunctionAccess().getAnnotationsAssignment_0_7(), "rule__Function__AnnotationsAssignment_0_7");
			builder.put(grammarAccess.getFunctionAccess().getBodyAssignment_0_8(), "rule__Function__BodyAssignment_0_8");
			...
			builder.put(grammarAccess.getPropertyAccess().getTypeRefAssignment_4_0_0(), "rule__Property__TypeRefAssignment_4_0_0");
			builder.put(grammarAccess.getPropertyAccess().getInitAssignment_4_0_1_1(), "rule__Property__InitAssignment_4_0_1_1");
			builder.put(grammarAccess.getPropertyAccess().getTensorAssignment_4_1(), "rule__Property__TensorAssignment_4_1");
			builder.put(grammarAccess.getPropertyAccess().getAnnotationsAssignment_5(), "rule__Property__AnnotationsAssignment_5");
			...
			builder.put(grammarAccess.getLocalVariableAccess().getTypeRefAssignment_4_0_0(), "rule__LocalVariable__TypeRefAssignment_4_0_0");
			builder.put(grammarAccess.getLocalVariableAccess().getInitAssignment_4_0_1_1(), "rule__LocalVariable__InitAssignment_4_0_1_1");
			builder.put(grammarAccess.getLocalVariableAccess().getTensorAssignment_4_1(), "rule__LocalVariable__TensorAssignment_4_1");
			builder.put(grammarAccess.getLocalVariableAccess().getAnnotationsAssignment_5(), "rule__LocalVariable__AnnotationsAssignment_5");
			...
			builder.put(grammarAccess.getVariableAssignmentAccess().getExtraPropertyAssignment_2_1(), "rule__VariableAssignment__ExtraPropertyAssignment_2_1");
			builder.put(grammarAccess.getVariableAssignmentAccess().getExtraIndexAssignment_2_2_1(), "rule__VariableAssignment__ExtraIndexAssignment_2_2_1");
			builder.put(grammarAccess.getVariableAssignmentAccess().getExpressionAssignment_4(), "rule__VariableAssignment__ExpressionAssignment_4");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getCpropertysAssignment_1(), "rule__CpropertyAssignment__CpropertysAssignment_1");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getCindexAssignment_2_1(), "rule__CpropertyAssignment__CindexAssignment_2_1");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getPropertyAssignment_3_1(), "rule__CpropertyAssignment__PropertyAssignment_3_1");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getPindexAssignment_3_2_1(), "rule__CpropertyAssignment__PindexAssignment_3_2_1");
			builder.put(grammarAccess.getCpropertyAssignmentAccess().getExpressionAssignment_5(), "rule__CpropertyAssignment__ExpressionAssignment_5");
			builder.put(grammarAccess.getStrategyStreamAccess().getInputsAssignment_1(), "rule__StrategyStream__InputsAssignment_1");
			builder.put(grammarAccess.getStrategyStreamAccess().getInputsAssignment_2_1(), "rule__StrategyStream__InputsAssignment_2_1");
			builder.put(grammarAccess.getStrategyStreamAccess().getStrategyAssignment_4(), "rule__StrategyStream__StrategyAssignment_4");
			builder.put(grammarAccess.getStrategyStreamAccess().getOutputsAssignment_6(), "rule__StrategyStream__OutputsAssignment_6");
			builder.put(grammarAccess.getStrategyStreamAccess().getOutputsAssignment_7_1(), "rule__StrategyStream__OutputsAssignment_7_1");
			builder.put(grammarAccess.getDictAssignmentAccess().getDictAssignment_0(), "rule__DictAssignment__DictAssignment_0");
			builder.put(grammarAccess.getDictAssignmentAccess().getElementsAssignment_1_1(), "rule__DictAssignment__ElementsAssignment_1_1");
			builder.put(grammarAccess.getDictAssignmentAccess().getVarAssignment_3(), "rule__DictAssignment__VarAssignment_3");
			builder.put(grammarAccess.getZipEnumerateAccess().getVarsAssignment_1(), "rule__ZipEnumerate__VarsAssignment_1");
			builder.put(grammarAccess.getZipEnumerateAccess().getVarsAssignment_2_1(), "rule__ZipEnumerate__VarsAssignment_2_1");
			builder.put(grammarAccess.getZipEnumerateAccess().getFnameAssignment_4(), "rule__ZipEnumerate__FnameAssignment_4");
			builder.put(grammarAccess.getZipEnumerateAccess().getSetsAssignment_6(), "rule__ZipEnumerate__SetsAssignment_6");
			builder.put(grammarAccess.getZipEnumerateAccess().getSetsAssignment_7_1(), "rule__ZipEnumerate__SetsAssignment_7_1");
			builder.put(grammarAccess.getZipEnumerateAccess().getActionAssignment_9(), "rule__ZipEnumerate__ActionAssignment_9");
			builder.put(grammarAccess.getAppendAccess().getPythonlistAssignment_0(), "rule__Append__PythonlistAssignment_0");
			builder.put(grammarAccess.getAppendAccess().getElementAssignment_4(), "rule__Append__ElementAssignment_4");
			...
			builder.put(grammarAccess.getPyforActionAccess().getVariablesAssignment_2(), "rule__PyforAction__VariablesAssignment_2");
			builder.put(grammarAccess.getPyforActionAccess().getVariablesAssignment_3_1(), "rule__PyforAction__VariablesAssignment_3_1");
			builder.put(grammarAccess.getPyforActionAccess().getArraysAssignment_5(), "rule__PyforAction__ArraysAssignment_5");
			builder.put(grammarAccess.getPyforActionAccess().getArraysAssignment_6_1(), "rule__PyforAction__ArraysAssignment_6_1");
			builder.put(grammarAccess.getPyforActionAccess().getActionAssignment_8(), "rule__PyforAction__ActionAssignment_8");
			...
			builder.put(grammarAccess.getReturnActionAccess().getExtraExpAssignment_3_1(), "rule__ReturnAction__ExtraExpAssignment_3_1");
			...
			builder.put(grammarAccess.getCpropertyReferenceAccess().getCpropertysAssignment_1(), "rule__CpropertyReference__CpropertysAssignment_1");
			builder.put(grammarAccess.getCpropertyReferenceAccess().getCindexAssignment_2_1(), "rule__CpropertyReference__CindexAssignment_2_1");
			builder.put(grammarAccess.getCpropertyReferenceAccess().getPropertyAssignment_3_1(), "rule__CpropertyReference__PropertyAssignment_3_1");
			builder.put(grammarAccess.getCpropertyReferenceAccess().getPindexAssignment_3_2_1(), "rule__CpropertyReference__PindexAssignment_3_2_1");
	...
	@Override
	protected InternalAiotMLParser createParser() {
		InternalAiotMLParser result = new InternalAiotMLParser(null);
