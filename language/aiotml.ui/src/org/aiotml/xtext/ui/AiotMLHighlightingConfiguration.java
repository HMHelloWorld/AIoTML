...
public class AiotMLHighlightingConfiguration extends DefaultHighlightingConfiguration {
	...
	public static final String CPROPERTY_ID = "CPROPERTY_ID";
	public static final String MODEL_AND_STRATEGY_ID = "MODEL_AND_STRATEGY_ID";
	public static final String OTHER_NOTES_ID = "OTHER_NOTES_ID";
	@Override
    public void configure(IHighlightingConfigurationAcceptor acceptor) {
        ...
        acceptor.acceptDefaultHighlighting(MODEL_AND_STRATEGY_ID, "MODEL_AND_STRATEGY", model_and_strategy());   
        acceptor.acceptDefaultHighlighting(OTHER_NOTES_ID, "OTHER_NOTES", other_notes());   
//        acceptor.acceptDefaultHighlighting(CPROPERTY_ID, "CPROPERTY", cproperty());   
    }
	
//	protected TextStyle cproperty() {
...
//    }
	...
	protected TextStyle model_and_strategy() {
        TextStyle textStyle = defaultTextStyle().copy();
        textStyle.setColor(new RGB(0, 85, 187));
        textStyle.setStyle(SWT.BOLD);
        return textStyle;
	...
	protected TextStyle other_notes() {
        TextStyle textStyle = defaultTextStyle().copy();
        textStyle.setColor(new RGB(84, 138, 66));
        textStyle.setStyle(SWT.BOLD);
        return textStyle;
