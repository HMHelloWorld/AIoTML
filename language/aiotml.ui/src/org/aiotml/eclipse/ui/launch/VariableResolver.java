...
public class VariableResolver implements IDynamicVariableResolver {
	...
	public String resolveValue(IDynamicVariable variable, String argument) throws CoreException {
		if (variable.getName().equals("aiotml.compiler")) {
			return currentLaunchConfiguration.getAttribute("org.aiotml.launchconfig.compiler", "");
		}
		if (variable.getName().equals("aiotml.model")) {
