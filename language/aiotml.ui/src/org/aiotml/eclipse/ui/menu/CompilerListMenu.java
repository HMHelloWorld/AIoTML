 ...
 */
package org.aiotml.eclipse.ui.menu;
...
import org.aiotml.eclipse.ui.launch.AiotMLLauncher;
...
public abstract class CompilerListMenu extends CompoundContributionItem implements IWorkbenchContribution {
	...
	protected IContributionItem[] getContributionItems() {
		...
		if (AiotMLLauncher.compiler_auto != null) {
			items.add(createCompilerCommandContributionItem(AiotMLLauncher.compiler_auto.getID(), AiotMLLauncher.compiler_auto.getName()));
			items.add(new Separator());
		}
		// Add actual compilers
		for (CompilerInfo compiler : AiotMLLauncher.compilers) {
