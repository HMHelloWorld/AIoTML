...
public class LaunchToolbarAction extends AbstractLaunchToolbarAction  {
	...
	public LaunchToolbarAction(String type, String toolTipPrefix) {
		super("org.aiotml.eclipse.ui.launchgroup."+type);
		this.launchGroupId = "org.aiotml.eclipse.ui.launchgroup."+type;
		this.toolbarItemId = "aiotml.ui.toolbar."+type;
		this.toolbarCommandId = "aiotml.ui.toolbar.commands."+type;
