...
public class AiotMLConsole {

	private static AiotMLConsole instance;
	
	//private static Color COLOR = new Color(new Display(), 0, 0, 0);
	
	public static AiotMLConsole getInstance() {
		if (instance == null) {
			instance = new AiotMLConsole();
		}
		return instance;
	}
	...
	private AiotMLConsole() {
		console = new IOConsole("[AiotML]", null);
