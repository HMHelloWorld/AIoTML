...
public class AiotMLLabelProvider extends DefaultEObjectLabelProvider {
  @Inject
  public AiotMLLabelProvider(final AdapterFactoryLabelProvider delegate) {
    super(delegate);
  }
  ...
  public String text(final Cproperty cproperty) {
    return cproperty.getName();
  }
  
  public String image(final Cproperty cproperty) {
    return "outline/open iconic/tag-2x.png";
  }
  
  public String text(final Strategy strategy) {
    return strategy.getName();
  }
  
  public String image(final Strategy strategy) {
    return "outline/open iconic/tag-2x.png";
  }
  
  public String text(final StrategyProperty strategyProperty) {
    return strategyProperty.getName();
  }
  
  public String image(final StrategyProperty strategyProperty) {
    return "outline/open iconic/tag-2x.png";
  }
  
  public String text(final SubThing subthing) {
    return subthing.getName();
  }
  
  public String image(final SubThing subthing) {
    return "heads.png";
  }
