 ...
 */
package org.aiotml.xtext.ui.quickfix;
...
public class AiotMLQuickfixProvider extends DefaultQuickfixProvider {
  @Fix("state-sink")
  ...
  public void makeOptional(final Issue issue, final IssueResolutionAcceptor acceptor) {
    ...
    final ISemanticModification _function = (EObject obj, IModificationContext context) -> {
      if ((obj instanceof Configuration)) {
        ...
        Port _findFirst = IterableExtensions.<Port>findFirst(AiotMLHelpers.allPorts(i.getType()), _function_2);
  ...
  public void implementFunction(final Issue issue, final IssueResolutionAcceptor acceptor) {
    ...
    final ISemanticModification _function = (EObject obj, IModificationContext context) -> {
      if (((issue.getData() != null) && (obj instanceof Thing))) {
        ...
        final Function abs = IterableExtensions.<Function>findFirst(AiotMLHelpers.allFunctions(thing), _function_1);
        final Function func = AiotMLFactory.eINSTANCE.createFunction();
        ...
        if (_tripleNotEquals_2) {
          final TypeRef typeRef = AiotMLFactory.eINSTANCE.createTypeRef();
        ...
        final Consumer<Parameter> _function_2 = (Parameter p) -> {
          final Parameter param = AiotMLFactory.eINSTANCE.createParameter();
          param.setName(p.getName());
          final TypeRef typeRef_1 = AiotMLFactory.eINSTANCE.createTypeRef();
