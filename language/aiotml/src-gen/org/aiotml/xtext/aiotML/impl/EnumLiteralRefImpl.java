 ...
 * </p>
 * <ul>
 *   <li>{@link org.aiotml.xtext.aiotML.impl.EnumLiteralRefImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link org.aiotml.xtext.aiotML.impl.EnumLiteralRefImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumLiteralRefImpl extends LiteralImpl implements EnumLiteralRef
{
  ...
  {
    return AiotMLPackage.Literals.ENUM_LITERAL_REF;
  }
    ...
    if (enum_ != null && enum_.eIsProxy())
    {
      ...
      if (enum_ != oldEnum)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AiotMLPackage.ENUM_LITERAL_REF__ENUM, oldEnum, enum_));
      }
    }
    return enum_;
  }
  ...
  public void setEnum(Enumeration newEnum)
  {
    ...
    enum_ = newEnum;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AiotMLPackage.ENUM_LITERAL_REF__ENUM, oldEnum, enum_));
  }
  ...
  public EnumerationLiteral getLiteral()
  {
    if (literal != null && literal.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AiotMLPackage.ENUM_LITERAL_REF__LITERAL, oldLiteral, literal));
      }
    }
    return literal;
  }
  ...
  public void setLiteral(EnumerationLiteral newLiteral)
  {
    ...
    literal = newLiteral;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AiotMLPackage.ENUM_LITERAL_REF__LITERAL, oldLiteral, literal));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AiotMLPackage.ENUM_LITERAL_REF__ENUM:
        if (resolve) return getEnum();
        return basicGetEnum();
      case AiotMLPackage.ENUM_LITERAL_REF__LITERAL:
