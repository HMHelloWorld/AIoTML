 ...
 * </p>
 * <ul>
 *   <li>{@link org.aiotml.xtext.aiotML.impl.ByteLiteralImpl#getByteValue <em>Byte Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ByteLiteralImpl extends LiteralImpl implements ByteLiteral
{
  ...
  {
    return AiotMLPackage.Literals.BYTE_LITERAL;
  }
  ...
  public void setByteValue(byte newByteValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AiotMLPackage.BYTE_LITERAL__BYTE_VALUE, oldByteValue, byteValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AiotMLPackage.BYTE_LITERAL__BYTE_VALUE:
        return getByteValue();
    }
