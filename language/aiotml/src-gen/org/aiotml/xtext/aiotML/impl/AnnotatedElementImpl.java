 ...
 * </p>
 * <ul>
 *   <li>{@link org.aiotml.xtext.aiotML.impl.AnnotatedElementImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotatedElementImpl extends MinimalEObjectImpl.Container implements AnnotatedElement
{
  ...
  {
    return AiotMLPackage.Literals.ANNOTATED_ELEMENT;
  }
  ...
  public EList<PlatformAnnotation> getAnnotations()
  {
    if (annotations == null)
    {
      annotations = new EObjectContainmentEList<PlatformAnnotation>(PlatformAnnotation.class, this, AiotMLPackage.ANNOTATED_ELEMENT__ANNOTATIONS);
    }
    return annotations;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AiotMLPackage.ANNOTATED_ELEMENT__ANNOTATIONS:
