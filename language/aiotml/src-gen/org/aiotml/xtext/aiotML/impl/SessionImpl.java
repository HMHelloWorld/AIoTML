 ...
 * </p>
 * <ul>
 *   <li>{@link org.aiotml.xtext.aiotML.impl.SessionImpl#getMaxInstances <em>Max Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SessionImpl extends StateContainerImpl implements Session
{
  ...
  {
    return AiotMLPackage.Literals.SESSION;
  }
  ...
  public NotificationChain basicSetMaxInstances(Expression newMaxInstances, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AiotMLPackage.SESSION__MAX_INSTANCES, oldMaxInstances, newMaxInstances);
  ...
  public void setMaxInstances(Expression newMaxInstances)
  {
    if (newMaxInstances != maxInstances)
    {
      ...
      if (maxInstances != null)
        msgs = ((InternalEObject)maxInstances).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AiotMLPackage.SESSION__MAX_INSTANCES, null, msgs);
      if (newMaxInstances != null)
        msgs = ((InternalEObject)newMaxInstances).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AiotMLPackage.SESSION__MAX_INSTANCES, null, msgs);
      msgs = basicSetMaxInstances(newMaxInstances, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AiotMLPackage.SESSION__MAX_INSTANCES, newMaxInstances, newMaxInstances));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AiotMLPackage.SESSION__MAX_INSTANCES:
