...
public class FunctionUsage extends AiotMLValidatorCheck {
  ...
  public void checkThread(final Function f) {
    if ((AnnotatedElementHelper.isDefined(f, "fork_thread", "true") || AnnotatedElementHelper.hasFlag(f, "fork_thread"))) {
      if (((f.getTypeRef() != null) && (f.getTypeRef().getType() != null))) {
        ...
        this.warning(msg, f, AiotMLPackage.eINSTANCE.getNamedElement_Name(), "function-thread-cannot-return", f.getName());
      }
    }
  }
  ...
  public void checkUsage(final Function f) {
    final Thing thing = AiotMLHelpers.findContainingThing(f);
    ...
    boolean _exists_1 = IterableExtensions.<FunctionCallExpression>exists(AiotMLHelpers.<FunctionCallExpression>getAllExpressions(thing, FunctionCallExpression.class), _function_1);
    if (_exists_1) {
      return;
    }
    final Function1<Thing, Boolean> _function_2 = (Thing included) -> {
      ...
      })) || IterableExtensions.<FunctionCallExpression>exists(AiotMLHelpers.<FunctionCallExpression>getAllExpressions(included, FunctionCallExpression.class), ((Function1<FunctionCallExpression, Boolean>) (FunctionCallExpression call) -> {
        String _name = call.getFunction().getName();
        String _name_1 = f.getName();
        return Boolean.valueOf(Objects.equal(_name, _name_1));
      }))));
    ...
    if ((!isUsedByIncludingThings)) {
      ...
      this.warning(msg, f, AiotMLPackage.eINSTANCE.getNamedElement_Name(), "function-never-called", f.getName());
    }
  }
  ...
  public void checkConcrete(final Thing t) {
      ...
      try {
        try {
          ...
          if (_t instanceof UnimplementedFunction) {
            ...
            final Thing origin = AiotMLHelpers.findContainingThing(f);
            boolean _equals = Objects.equal(origin, t);
            if (_equals) {
              this.error(e.getMessage(), f, AiotMLPackage.eINSTANCE.getNamedElement_Name(), "function-not-implemented", f.getName());
            } else {
              this.error(e.getMessage(), t, AiotMLPackage.eINSTANCE.getThing_Includes(), t.getIncludes().indexOf(origin), "function-not-implemented", f.getName());
            }
          } else if (_t instanceof FunctionWithMultipleImplem) {
            final FunctionWithMultipleImplem e_1 = (FunctionWithMultipleImplem)_t;
            final Thing origin_1 = AiotMLHelpers.findContainingThing(f);
            boolean _equals_1 = Objects.equal(origin_1, t);
            if (_equals_1) {
              this.error(e_1.getMessage(), t, AiotMLPackage.eINSTANCE.getNamedElement_Name(), "function-many-impl", f.getName());
            } else {
              this.error(e_1.getMessage(), t, AiotMLPackage.eINSTANCE.getThing_Includes(), t.getIncludes().indexOf(origin_1), "function-many-impl", f.getName());
            }
          } else {
    ...
    IterableExtensions.<Function>filter(AiotMLHelpers.allFunctions(t), _function).forEach(_function_1);
  }
  ...
  public void checkParameters(final Function f) {
    ...
    if (_not) {
      final List<PropertyReference> refs = AiotMLHelpers.<PropertyReference>getAllExpressions(f, PropertyReference.class);
      ...
      final Procedure2<Parameter, Integer> _function = (Parameter p, Integer i) -> {
        ...
        if ((!isUsed)) {
          ...
          this.warning(_plus_1, f, AiotMLPackage.eINSTANCE.getFunction_Parameters(), (i).intValue(), "parameter-not-used");
        }
  ...
  public void checkBlock(final ActionBlock block) {
    ...
    if (((indexOfFirstReturn >= 0) && (indexOfFirstReturn < (block.getActions().size() - 1)))) {
      ...
      this.error(msg, block, AiotMLPackage.eINSTANCE.getActionBlock_Actions(), (indexOfFirstReturn + 1), "unreachable-code", Integer.valueOf(indexOfFirstReturn).toString());
    }
  }
  ...
  public void checkReturnType2(final Function f) {
    if ((((!f.isAbstract()) && (f.getTypeRef() != null)) && (f.getTypeRef().getType() != null))) {
      ...
      if (_not) {
        final Type actualType = TyperHelper.getBroadType(f.getTypeRef().getType());
        String _name = f.getName();
        String _plus = ("Function " + _name);
        ...
        this.error(msg, f, AiotMLPackage.eINSTANCE.getNamedElement_Name(), "missing-return", f.getName());
        return;
      }
    }
  }
    ...
    if (_not) {
      if (((f.getTypeRef() != null) && (f.getTypeRef().getType() != null))) {
        final Consumer<ReturnAction> _function = (ReturnAction ra) -> {
          final Type actualType = TyperHelper.getBroadType(f.getTypeRef().getType());
          final Type returnType = TypeChecker.computeTypeOf(ra.getExp());
          final Object parent = ra.eContainer().eGet(ra.eContainingFeature());
          boolean _equals = returnType.equals(Types.ERROR_TYPE);
          if (_equals) {
            String _name = f.getName();
            String _plus = ("Function " + _name);
            ...
            String _name_2 = returnType.getName();
            ...
            boolean _equals_1 = returnType.equals(Types.ANY_TYPE);
            if (_equals_1) {
              String _name_3 = f.getName();
              String _plus_5 = ("Function " + _name_3);
              String _plus_6 = (_plus_5 + " should return ");
              String _name_4 = actualType.getName();
              ...
              if (_not_1) {
                ...
                String _plus_8 = ("Function " + _name_5);
                String _plus_9 = (_plus_8 + " should return ");
                String _name_6 = actualType.getName();
                String _plus_10 = (_plus_9 + _name_6);
                String _plus_11 = (_plus_10 + ". Found ");
                String _name_7 = returnType.getName();
  ...
  public void checkFunctionCallAction(final FunctionCallStatement call) {
    final Thing t = AiotMLHelpers.findContainingThing(call);
    ...
    final Procedure2<Parameter, Integer> _function = (Parameter p, Integer i) -> {
      ...
      if ((actual != null)) {
        ...
        if (_equals) {
          ...
          final String msg_1 = (_plus_7 + _name_3);
          if ((parent instanceof EList)) {
          ...
          if (((!ignore) && actual.equals(Types.ANY_TYPE))) {
            ...
            String _plus_8 = ("Function " + _name_4);
            ...
            if (_not) {
              ...
              String _plus_9 = ("Function " + _name_5);
              ...
              final String msg_3 = (_plus_12 + _name_7);
              if ((parent instanceof EList)) {
