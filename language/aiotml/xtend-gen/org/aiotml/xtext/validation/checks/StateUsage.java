...
public class StateUsage extends AiotMLValidatorCheck {
  @Check(CheckType.FAST)
  public void chectStateUniqueness(final org.aiotml.xtext.aiotML.State s) {
    ...
    if ((_eContainer instanceof StateContainer)) {
      ...
      final Function1<org.aiotml.xtext.aiotML.State, Boolean> _function = (org.aiotml.xtext.aiotML.State s2) -> {
        String _name = s2.getName();
        String _name_1 = s.getName();
        return Boolean.valueOf(Objects.equal(_name, _name_1));
      };
      final Iterable<org.aiotml.xtext.aiotML.State> states = IterableExtensions.<org.aiotml.xtext.aiotML.State>filter(c.getSubstate(), _function);
      ...
      if (_greaterThan) {
        ...
        this.error(msg, c, AiotMLPackage.eINSTANCE.getStateContainer_Substate(), c.getSubstate().indexOf(s), 
          "duplicate-state");
      }
    }
  }
  ...
  public void checkSessionUniqueness(final Session s) {
    ...
    if (_greaterThan) {
      ...
      final String msg = (_plus + " is duplicated.");
      this.error(msg, c, AiotMLPackage.eINSTANCE.getCompositeState_Session(), c.getSubstate().indexOf(s), "duplicate-session");
    }
  }
  ...
  public void chectRegionUniqueness(final Region r) {
    ...
    if (_greaterThan) {
      ...
      final String msg = (_plus + " is duplicated.");
      this.error(msg, c, AiotMLPackage.eINSTANCE.getCompositeState_Region(), c.getRegion().indexOf(r), "duplicate-region");
    }
  }
  
  @Check(CheckType.FAST)
  public void checkUnreachableState(final StateContainer sc) {
    final Procedure2<org.aiotml.xtext.aiotML.State, Integer> _function = (org.aiotml.xtext.aiotML.State s, Integer i) -> {
      org.aiotml.xtext.aiotML.State _initial = sc.getInitial();
      boolean _tripleEquals = (_initial == s);
      if (_tripleEquals) {
        return;
      }
      final Function1<org.aiotml.xtext.aiotML.State, Boolean> _function_1 = (org.aiotml.xtext.aiotML.State st) -> {
        final Function1<Transition, Boolean> _function_2 = (Transition t) -> {
          org.aiotml.xtext.aiotML.State _target = t.getTarget();
      ...
      final boolean isReachable = IterableExtensions.<org.aiotml.xtext.aiotML.State>exists(sc.getSubstate(), _function_1);
      if ((!isReachable)) {
        String _name = s.getName();
        String _plus = ("State " + _name);
        String _plus_1 = (_plus + " is unreachable");
        this.warning(_plus_1, sc, AiotMLPackage.eINSTANCE.getStateContainer_Substate(), (i).intValue(), 
          "state-unreachable", s.getName());
      }
    };
    IterableExtensions.<org.aiotml.xtext.aiotML.State>forEach(sc.getSubstate(), _function);
  }
  ...
  public void checkSinkState(final CompositeState c) {
    ...
    final Procedure2<org.aiotml.xtext.aiotML.State, Integer> _function = (org.aiotml.xtext.aiotML.State s, Integer i) -> {
      ...
      this.warning(_plus_1, s, AiotMLPackage.eINSTANCE.getNamedElement_Name(), "state-sink", s.getName());
    };
    IterableExtensions.<org.aiotml.xtext.aiotML.State>forEach(c.getSubstate(), _function);
  }
}
